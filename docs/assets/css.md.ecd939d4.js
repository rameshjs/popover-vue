import { _ as s, c as n, o as a, a as p } from "./app.39ffa6d2.js";
const A = JSON.parse(
    '{"title":"CSS","description":"","frontmatter":{},"headers":[],"relativePath":"css.md"}'
  ),
  l = { name: "css.md" },
  o = p(
    `<h1 id="css" tabindex="-1">CSS <a class="header-anchor" href="#css" aria-hidden="true">#</a></h1><p>To customize the appearance of the popover, you can use the following CSS variables.</p><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">--popover-content-background</span></span>
<span class="line"><span style="color:#A6ACCD;">--popover-content-padding</span></span>
<span class="line"><span style="color:#A6ACCD;">--popover-content-border-radius</span></span>
<span class="line"><span style="color:#A6ACCD;">--popover-content-z-index</span></span>
<span class="line"><span style="color:#A6ACCD;">--popover-content-box-shadow</span></span>
<span class="line"></span></code></pre></div><p>You have the ability to overwrite them in any way you prefer, such as within a Vue component:</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">template</span><span style="color:#89DDFF;">&gt;</span></span>
